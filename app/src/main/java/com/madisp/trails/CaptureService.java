...
public class CaptureService extends Service {
    ...
    private void record() {
        ...
        try {
            ...
            format.setInteger(MediaFormat.KEY_BIT_RATE, 2048);
            ...
            format.setFloat(MediaFormat.KEY_FRAME_RATE, 15.0f);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.i(filename,"Created file "+filename);
